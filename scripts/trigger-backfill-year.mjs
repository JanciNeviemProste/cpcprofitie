// Recover year from detail descriptions already stored in the database.
//
// No crawling: /api/admin/backfill-year runs the fixed year extractor over listing_details.description,
...
const BASE = 'https://cpcprofitie.vercel.app/api/admin/backfill-year';
...
console.log(`backfill-year hotovo, spolu updatnutych: ${total}`);
