// Recover mileage from detail descriptions already stored in the database.
//
// No crawling: /api/admin/backfill-mileage runs the fixed year extractor over listing_details.description,
...
const BASE = 'https://cpcprofitie.vercel.app/api/admin/backfill-mileage';
...
console.log(`backfill-mileage hotovo, spolu updatnutych: ${total}`);
